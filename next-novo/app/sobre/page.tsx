...
export default function Equipe(){
    return(
        ...
        <div className='sobre'>
        <p className="paragrafo-sobre destaque">Este site foi desenvolvido com o objetivo de auxiliar mestres e jogadores de RPG na criação rápida de NPCs (Personagens Não Jogáveis) aleatórios.</p>
